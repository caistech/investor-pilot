...
// Next.js 14 bails out of static prerendering for any page calling
// useSearchParams() unless it's wrapped in a Suspense boundary. Without
// the wrapper the build fails with "useSearchParams() should be wrapped
// in a suspense boundary at page /invite/accept" — exactly what broke
// production deploys for an hour after Lane D landed.
    ...
    <div className="min-h-screen bg-dark-950 flex flex-col">
      ...
      <main className="flex-1 flex items-center justify-center px-4 py-12">
        <div className="w-full max-w-md bg-dark-900 border border-dark-700 rounded-xl p-8">
          <Suspense fallback={<p className="text-dark-300 text-center">Loading invitation…</p>}>
            <AcceptInviteContent />
          </Suspense>
        </div>
      </main>
